    ...
    >
      ...
      <div className="flex shrink-0 items-center gap-2">
        ...
        <button
          ...
          className="cursor-pointer rounded-[var(--radius-sm)] p-1.5 text-[var(--text-tertiary)] transition-colors hover:bg-[var(--background-tertiary)] hover:text-[var(--text-primary)]"
        >
