...
The app includes a **credit system** and **three plans** (Creator, Pro, Team) with monthly and annual billing and a 14-day free trial for Pro and Team. See the [Pricing](http://localhost:3000/pricing) page in the app and [PRICING.plan.md](docs/plans/PRICING.plan.md) for the credit breakdown and plan details.
